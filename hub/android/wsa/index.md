...
Windows Subsystem for Android is currently only available through **preview** via all WIP Channels of the [Windows Insiders Program](https://insider.windows.com/) (Windows 11 Build 22000.xxx series) in the U.S. only.
